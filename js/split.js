...
(function () {
    ...
    pCube.drawElements = function (datasets, geoMap) {
        ...
        WGLRenderer.setSize(leftPane.offsetWidth, leftPane.offsetHeight);
        ...
        leftPane.appendChild(WGLRenderer.domElement);
        ...
        renderer.setSize(leftPane.offsetWidth, leftPane.offsetHeight);
        ...
        camera = new THREE.PerspectiveCamera(40, leftPane.offsetWidth / leftPane.offsetHeight, 1, 10000);
    ...
    pCube.onWindowResize = function () {
        ...
        camera.aspect = leftPane.offsetWidth / leftPane.offsetHeight;
