    ...
    function AppComponent(google, compRef) {
        ...
        this.positionCamera = function () {
            ...
            if (_this.gCube.cubeToggle) {
                ...
                currentXPos += _cube_config__WEBPACK_IMPORTED_MODULE_11__["CUBE_CONFIG"].WIDTH + _cube_config__WEBPACK_IMPORTED_MODULE_11__["CUBE_CONFIG"].GUTTER;
            }
...
const CUBE_CONFIG = {
    ...
    NODE_SIZE: 2,
    DATA_SET: {
        // id: '1j-FnypM3zD2fjWWoZUa_X6ENh4LosKF627fZoXKSxpY', // Cushman
        // id: '1HLjB2soptO8PGLgGmQ7kOYkHQhEx18KJknWp6nMU31w',
        // id: '1lbK2QxF2dI-1GskjOqeI8t_E4xIqVd8exRA2fwtKAIQ',
        id: '1Jlzzxbv-tLgW475NmoDbsXlyXtVIhtZn2KW2l6Gw5LI', // IMDB
        name: 'Cushman'
    }
}
            ...
            return new Promise(function (resolve, reject) {
                _this.http.get(url)
                    ...
                    data.forEach(function (item) {
                        ...
                        item.target_nodes = String(item.target_nodes).split(';').map(Number);
